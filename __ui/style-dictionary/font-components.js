// config.js
module.exports = {
    source: [`tokens/font/font-basics.json`, `tokens/font/font-components.json`],
    ...
    platforms: {
       ...
       "scss": {
        ...
        "files": [{
          "destination": "font-components.scss", // nombre de archivo 
          "format": "myFormat", // formato 
          "mapName": "font-components"
        }]
      }
    }
  }