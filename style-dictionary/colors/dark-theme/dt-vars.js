// config.js
module.exports = {
    source: [`__ui/tokens/fixed-colors.json`, `__ui/tokens/colors/theme-dark-colors.json`],
    ...
    format: {
        ...
        //ATENCIÓN:
        //Esto intencionalmente está generando un archivo de variables vacío ya que hay limitaciones técnicas para implementar el dark mode
        //Si se desea cambiar debe comentarse la linea 81 y descomentarse la linea 83
...
console.log(formatSeparator);
    ...
    platforms: {
       ...
       "scss": {
        ...
        "buildPath": "__ui/abstracts/variables/colors/dark-theme/", // la ruta donde irá nuestro archivo de salida 
        "files": [{
