// config.js
module.exports = {
  source: [`__ui/tokens/__absolute-colors.json`, `__ui/tokens/colors/theme-light-colors.json`],
  ...
  format: {
    ...
    //ATENCIÓN:
    //Esto intencionalmente está generando un archivo de variables sin un  @media(prefers-color-scheme: light) ya que que hay limitaciones técnicas para implementar el dark mode
    //Si se desea cambiar debe comentarse la linea 73 y descomentarse la linea 63
...
console.log(formatSeparator);
  ...
  platforms: {
     ...
     "scss": {
      ...
      "buildPath": "__ui//abstracts/variables/colors/light-theme/", // la ruta donde irá nuestro archivo de salida 
      "files": [{
        "destination": "lt-vars.scss", // nombre de archivo 
