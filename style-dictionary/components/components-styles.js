...
module.exports = {
    ...
    source: [
      `__ui/tokens/colors/*`, 
      `__ui/tokens/foundation-tokens.json`, 
      `__ui/tokens/${nombreCarpetaComponentes}/*`,
...
let formatSeparator = format.replaceAll(",", ""); 
    ...
    platforms: {   
       ...
       "scss": {
        ...
        "buildPath": "__ui//abstracts/variables/components/", // la ruta donde irá nuestro archivo de salida 
        "files": [{
