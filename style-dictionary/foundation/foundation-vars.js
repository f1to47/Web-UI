// config.js
module.exports = {
    source: [`__ui/tokens/colors/absolute-colors.json`, `__ui/tokens/theme-light-colors.json`, `__ui/tokens/foundation-tokens.json`],
...
console.log(formatSeparator);
    ...
    platforms: {
       ...
       "scss": {
        ...
        "buildPath": "__ui//abstracts/variables/foudation/", // la ruta donde irá nuestro archivo de salida 
        "files": [{
